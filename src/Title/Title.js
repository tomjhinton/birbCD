...
<Text3D scale={1.25} font={'Basement Grotesque Roman_Bold (1).json'} ref={text} position={[-12,4,0]}
onPointerDown={handleMouseDown}
onPointerOver={ ()=>  document.body.style.cursor = 'pointer'}
onPointerLeave={ ()=>  document.body.style.cursor = 'auto'}
>
Break Me <titleMaterial ref={titleMaterial} side={THREE.DoubleSide} transparent/>
